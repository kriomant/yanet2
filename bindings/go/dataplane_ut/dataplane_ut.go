...
#cgo LDFLAGS: -L../../../build/modules/portfwd/dataplane
...
#cgo LDFLAGS: -lblackhole_dp -ldecap_dp -ldscp_dp -lacl_dp -lfwstate_dp -lforward_dp -lmirror_dp -lportfwd_dp -lroute_dp -lnat64_dp -lpdump_dp
...
keep_refs(void **ptrs) {
	...
	extern struct module *new_module_portfwd(void);
